...
#import "FrankReleaseStudentCell.h"

@implementation FrankReleaseStudentCell
...
//        self.apointBtn.backgroundColor = [lhColor colorFromHexRGB:mainColorStr];
        [self.apointBtn setBackgroundImage:imageWithName(@"lookApointStudent") forState:UIControlStateNormal];
        self.apointBtn.layer.cornerRadius = 5*widthRate;
//        [self.apointBtn setTitle:@"查看" forState:UIControlStateNormal];
